  ...
  function (e, t, s) {
            ...
            void 0 !== r &&
              ...
              (C(e[n]) && C(i[n])
                ? i[n].__swiper__
                  ...
                  : T(e[n], i[n])
                : !C(e[n]) && C(i[n])
                ? ((e[n] = {}), i[n].__swiper__ ? (e[n] = i[n]) : T(e[n], i[n]))
                : (e[n] = i[n]));
          }
        }
      }
    ...
    function Q(e) {
      ...
      function c() {
        ...
        if (
          ("fraction" === s.type &&
            (r.find(J(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
            r.find(J(s.totalClass)).text(s.formatFractionTotal(p))),
          "progressbar" === s.type)
        ) {
          let e;
      ...
      function u() {
        ...
        0 !== s.length &&
          ...
          e.clickable &&
            s.on("click", J(e.bulletClass), function (e) {
              e.preventDefault();
      ...
      function h() {
        ...
        s.removeClass(e.hiddenClass),
          ...
          e.clickable && s.off("click", J(e.bulletClass));
      }
      i("init", () => {
        u(), p(), c();
      }),
    ...
    ((Y = Element.prototype).matches =
      ...
      (function () {
        var e = document.querySelectorAll(".process-parent__item"),
          t = document.querySelector(".header-button"),
          s = document.querySelector(".header-content__nav"),
          i = document.querySelectorAll(".features-accordeon__item"),
          n = document.querySelectorAll(".tokenomics-accordeon__item"),
          r = document.querySelector(".process-parent"),
          a = document.querySelectorAll(".process-item__button"),
          l = document.querySelector(".main-info__button");
        window.addEventListener("scroll", function () {
          var t = document.querySelector(".process-parent"),
            s = window.pageYOffset - t.offsetTop,
            i = t.scrollHeight,
            n = 0;
          n =
            s < (i / 6) * 1 - 500
          ...
          for (var r = 0; r < e.length; r++)
            e[r].classList.remove("view"),
              e[r].classList.remove("active"),
              r <= n && e[r].classList.add("view");
        ...
        function c(e) {
          for (
            var t = document.querySelectorAll(".vision-main__face img"),
              s = document.querySelectorAll(".vision-main__planet img"),
              i = document.querySelector(".vision-main__planet img.active"),
              n = document.querySelectorAll(".vision-main__text div"),
              r = document.querySelector(".vision-main__triangle"),
              a = 0;
            a < s.length;
            a++
          )
            s[a].classList.remove("active");
          s[e].classList.add("active");
          for (var l = 0; l < n.length; l++) n[l].classList.remove("active");
                  ...
                  (function (e, t) {
                    var s = 0,
                      i = setInterval(function () {
                        (e.innerHTML = ++s), s == t && clearInterval(i);
                      }, 40);
                  })(document.querySelector(".vision-main__triangle span"), 31);
              }, 100),
              setTimeout(function () {
                t[0].classList.add("active"), t[1].classList.remove("active");
              }, 500),
              t[0].classList.remove("active"),
              t[1].classList.add("active"));
        }
        function p() {
          var e = document.querySelector(".header-button"),
            t = document.querySelector(".header-content"),
            s = document.querySelector(".header-name");
              ...
              n.addEventListener(t, function (t) {
                ...
                t.stopPropagation(),
                  e.forEach(function (e) {
                    return e != n && e.classList.remove("".concat(s));
                  }),
                  this.classList != "".concat(s) &&
                    this.classList[i ? "toggle" : "add"]("".concat(s));
              });
            });
          });
        }
        new X(".swiper-slider", { slidesPerView: "auto" }),
          new X(".features-slider", {
            loop: !0,
            modules: [K, Q],
            pagination: {
          ...
          new X(".vision-slider", {
            ...
            on: {
              slideChangeTransitionStart: function () {
                c(
                  document
                    .querySelector(".vision-slider__item.swiper-slide-active")
          ...
          window.addEventListener("scroll", function () {
            if (window.innerWidth > 1024) {
              var e = document.querySelector(".vision"),
                t = window.pageYOffset - e.offsetTop + 500,
                s = e.scrollHeight;
              c(
                t < (s / 7) * 1
                  ? 0
          ...
          window.addEventListener("load", function () {
            var e = document.querySelector(".main-back"),
              t = document.querySelector(".main-back__head");
          ...
          l.addEventListener("click", function (e) {
            document
              .querySelector("#whatwedo")
              .scrollIntoView({ behavior: "smooth", block: "start" });
          }),
          t.addEventListener("click", p),
          s.addEventListener("click", function (e) {
            e.target.closest(".header-content__nav-link") && p();
          }),
          u(i, "click"),
          u(n, "click");
      })();
